...
3. Offset (a covariate): $\texttt{area_mm2}$. The area of the kidney tissue containing the counted cells.
...
### Instead of a *t*-test or Mann-Whitney test of a proportion (e.g. percent of cells expressing a specific marker), fit a GLM Binomial model to gain power (sox21 Fig. 5d) {#sec-glm-proportion}
