...
```{r fig3d_m1-plot-the-response, echo = TRUE}
...
```{r fig3d_m1-plot-the-model, echo = TRUE, caption = "xxx"}
...
1. Different ways of reporting the results in increasing order of not making claims that are not evidenced by the statistical analysis, 
