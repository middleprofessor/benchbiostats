...
1. This function only computes the Holm-Sidak *p*-value and not the adjusted CIs. The Holm CI's will be close. For Holm-Sidak CIs see the function `RHSDB::rh.sd.sidak`
