# Models for non-independence -- linear mixed models {#lmm}
...
# plots
set.seed(1)
gg1 <- ggplot_the_response(m1, m1_emm, m1_pairs, y_label = "Muscle Area") +
  ggtitle("naive ANOVA\n(n = 6)")
set.seed(1)
gg2 <- ggplot_the_response(m1b, m1b_emm, m1b_pairs, y_label = "Muscle Area") +
  ggtitle("naive ANOVA\n(n = 10)")
set.seed(1)
...
1. `(treatment | experiment_id)` specifies a random intercept for all levels of $\texttt{experiment_id}$ and
a random slope for all combinations the levels of $\texttt{experiment_id}$ and the non-reference levels of $\texttt{treatment}$
