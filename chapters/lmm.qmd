...
if(do_sim == TRUE){
  for(param_set in 1:nrow(param_set_matrix)){
    ...
    for(i in 1:n_sims){
      ...
      pptt_pairs <- pairwise_paired_tt(y_col = "sim_1",
                              g_col = "treatment",
                              id_col = "experiment",
...
1. lmm1/aov1/pptt, and lmm2 have well-behaved type I error rates (lmm2 is a little anti-conservative) regardless of correlation structure -- False discoveries should be well controlled.
