...
To deconstruct what this means, and the implications of the meaning, let's use the fig2i data from Figure 2i in the study on the browning of white adipose tissue in mice that was introduced in the introductory chapter [Analyzing experimental data with a linear model](@sec-intro).
